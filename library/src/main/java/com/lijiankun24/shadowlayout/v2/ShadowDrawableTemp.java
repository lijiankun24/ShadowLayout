 ...
 */
public class ShadowDrawableTemp extends Drawable{
...
//    static RoundRectHelper sRoundRectHelper;
    static ShadowHelper sRoundRectHelper;
    ...
    ShadowDrawableTemp(Resources resources, ColorStateList backgroundColor, float radius,
